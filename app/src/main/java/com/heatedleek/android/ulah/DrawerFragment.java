...
public class DrawerFragment extends Fragment {
    ...
    private ActionBarDrawerToggle uDrawerToggle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                uDrawerLayout.closeDrawer(containerView);
            }
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        uDrawerLayout = drawerLayout;
        uDrawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close) {
            @Override
        ...
        uDrawerLayout.post(new Runnable() {
            @Override
            public void run() {
